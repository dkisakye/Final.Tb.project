...
getwd()
gene.list.down <- list.files(path = "./meta_analyses/meta_analysis_rankprod/data_out", pattern = "\\.200\\.down", full.names = F)


genes.down <-lapply(gene.list.down, function(f){
...
```{r results="asis"}
search.terms <- c("ETV3L human tf ARCHS4 coexpression",
                  "24523406",
                  "^ETV3L\t",
                  "^RELA human\t")
