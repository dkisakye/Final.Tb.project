...
genes.down<- scan(file = data.file, what = "character")
...
enrichr.files<-grep(enrichr.files, pattern = "enrichr_TRRUST_Transcription_Factors_2019.txt" , invert = T , value = T)
...
class(enrichr.gene.sets) # "list"
 length(enrichr.gene.sets) # 3
# names(enrichr.gene.sets)

str(enrichr.gene.sets)
# List of 3
#[1] "list"
#$ ARCHS4_TFs_Coexp_/_HHEX_human_tf_ARCHS4_coexpression: chr [1:299] "UNC13D" "RUNX1" "SYTL1" "SCAMP2" ...
 # $ ChEA_2016_/_NR1H3_23393188_ChIP-Seq                 : chr [1:599] "WSB1" "SOX13" "NUP210" "RFX2" ...
 # $ Submissions_TF_Gene_Coocurrence_/_LYL1              : chr [1:299] "RUNX1" "PSMB9" "COL1A1" "VIM" ...
```
...
# get.stats.table <- function(geneset.list, gene.symbols.v, all.genes) {
  ...
  overlap <- intersect(genes.down, gene.symbols.v)
